<php>
  ...
  <body>
    ...
    <p style="font-size: 35px;">Select a Motherboard</p>
    <div id='disp'></div>
    <footer>
          <div class="footer">
      ...
      function callme(){
        ...
        ourrequest.onload = function(){
            ...
            for(var i=0;i<ourdata.length;i++)
            {
            	...
            	{
                    for (var j = 0; j < ourdata[i].Motherboard.length; j++)
                    {
                		output += '<center><table style="width:85%;color:white;"><tr><td><a  style="all:unset;"href="graphics_final.php?Var1='+ourdata[i].Processor+'&Var2='+ourdata[i].Motherboard[j]+'">'+ ourdata[i].Motherboard[j] +'</a></td></tr>';
                    }
                }
              }
            output+='</table></center>';
